 ...
 * @author Lasiru
 */
public class Classes2 extends javax.swing.JFrame {
    ...
    public void Record() {
        try {
            ...
            String sql = "select * from student where Class = 'Grade 1' ";
            ...
            String eee = "select count(*) from student where Class = 'Grade 1'";
    ...
    private void initComponents() {
        ...
        if (table_all.getColumnModel().getColumnCount() > 0) {
            table_all.getColumnModel().getColumn(1).setResizable(false);
        }
        ...
        jPanel1.add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(1033, 120, -1, 70));

        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, -3, -1, 680));
    ...
    private void combo_gradeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_combo_gradeActionPerformed
        try {
            ...
            if (combo_grade.getSelectedItem().equals("Grade 1")) {
                String query = "select * from student where Class = 'Grade 1' ";
            ...
            if (combo_grade.getSelectedItem().equals("Grade 2")) {
                String query = "select * from student where Class = 'Grade 2' ";
                ResultSet rs = stmt.executeQuery(query);
                table_all.setModel(DbUtils.resultSetToTableModel(rs));

                String eee = "select count(*) from student where Class = 'Grade 2'";
                ResultSet ss = stmt.executeQuery(eee);
                ss.next();
                int count = ss.getInt(1);
                std_total.setText("Total Students : " + count);
            ...
            if (combo_grade.getSelectedItem().equals("Grade 3")) {
                String query = "select * from student where Class = 'Grade 3' ";
                ResultSet rs = stmt.executeQuery(query);
                table_all.setModel(DbUtils.resultSetToTableModel(rs));

                String eee = "select count(*) from student where Class = 'Grade 3'";
                ResultSet ss = stmt.executeQuery(eee);
                ss.next();
                int count = ss.getInt(1);
                std_total.setText("Total Students : " + count);
            ...
            if (combo_grade.getSelectedItem().equals("Grade 4")) {
                String query = "select * from student where Class = 'Grade 4' ";
                ResultSet rs = stmt.executeQuery(query);
                table_all.setModel(DbUtils.resultSetToTableModel(rs));

                String eee = "select count(*) from student where Class = 'Grade 4'";
                ResultSet ss = stmt.executeQuery(eee);
                ss.next();
                int count = ss.getInt(1);
                std_total.setText("Total Students : " + count);
            ...
            if (combo_grade.getSelectedItem().equals("Grade 5")) {
                String query = "select * from student where Class = 'Grade 5' ";
                ResultSet rs = stmt.executeQuery(query);
                table_all.setModel(DbUtils.resultSetToTableModel(rs));

                String eee = "select count(*) from student where Class = 'Grade 5'";
                ResultSet ss = stmt.executeQuery(eee);
                ss.next();
                int count = ss.getInt(1);
                std_total.setText("Total Students : " + count);
            ...
            if (combo_grade.getSelectedItem().equals("Grade 6")) {
                String query = "select * from student where Class = 'Grade 6' ";
                ResultSet rs = stmt.executeQuery(query);
                table_all.setModel(DbUtils.resultSetToTableModel(rs));

                String eee = "select count(*) from student where Class = 'Grade 6'";
                ResultSet ss = stmt.executeQuery(eee);
                ss.next();
                int count = ss.getInt(1);
                std_total.setText("Total Students : " + count);
            ...
            if (combo_grade.getSelectedItem().equals("Grade 7")) {
                String query = "select * from student where Class = 'Grade 7' ";
                ResultSet rs = stmt.executeQuery(query);
                table_all.setModel(DbUtils.resultSetToTableModel(rs));

                String eee = "select count(*) from student where Class = 'Grade 7'";
                ResultSet ss = stmt.executeQuery(eee);
                ss.next();
                int count = ss.getInt(1);
                std_total.setText("Total Students : " + count);
            ...
            if (combo_grade.getSelectedItem().equals("Grade 8")) {
                String query = "select * from student where Class = 'Grade 8' ";
                ResultSet rs = stmt.executeQuery(query);
                table_all.setModel(DbUtils.resultSetToTableModel(rs));

                String eee = "select count(*) from student where Class = 'Grade 8'";
                ResultSet ss = stmt.executeQuery(eee);
                ss.next();
                int count = ss.getInt(1);
                std_total.setText("Total Students : " + count);
            ...
            if (combo_grade.getSelectedItem().equals("Grade 9")) {
                String query = "select * from student where Class = 'Grade 9' ";
                ResultSet rs = stmt.executeQuery(query);
                table_all.setModel(DbUtils.resultSetToTableModel(rs));

                String eee = "select count(*) from student where Class = 'Grade 9'";
                ResultSet ss = stmt.executeQuery(eee);
                ss.next();
                int count = ss.getInt(1);
                std_total.setText("Total Students : " + count);
            ...
            if (combo_grade.getSelectedItem().equals("Grade 10")) {
                String query = "select * from student where Class = 'Grade 10' ";
                ResultSet rs = stmt.executeQuery(query);
                table_all.setModel(DbUtils.resultSetToTableModel(rs));

                String eee = "select count(*) from student where Class = 'Grade 10'";
                ResultSet ss = stmt.executeQuery(eee);
                ss.next();
                int count = ss.getInt(1);
                std_total.setText("Total Students : " + count);
            ...
            if (combo_grade.getSelectedItem().equals("Grade 11")) {
                String query = "select * from student where Class = 'Grade 11' ";
                ResultSet rs = stmt.executeQuery(query);
                table_all.setModel(DbUtils.resultSetToTableModel(rs));

                String eee = "select count(*) from student where Class = 'Grade 11'";
                ResultSet ss = stmt.executeQuery(eee);
                ss.next();
                int count = ss.getInt(1);
                std_total.setText("Total Students : " + count);
            ...
            if (combo_grade.getSelectedItem().equals("Grade 12")) {
                String query = "select * from student where Class = 'Grade 12' ";
                ResultSet rs = stmt.executeQuery(query);
                table_all.setModel(DbUtils.resultSetToTableModel(rs));

                String eee = "select count(*) from student where Class = 'Grade 12'";
                ResultSet ss = stmt.executeQuery(eee);
                ss.next();
                int count = ss.getInt(1);
                std_total.setText("Total Students : " + count);
            ...
            if (combo_grade.getSelectedItem().equals("Grade 13")) {
                String query = "select * from student where Class = 'Grade 13' ";
                ResultSet rs = stmt.executeQuery(query);
                table_all.setModel(DbUtils.resultSetToTableModel(rs));

                String eee = "select count(*) from student where Class = 'Grade 13'";
                ResultSet ss = stmt.executeQuery(eee);
                ss.next();
                int count = ss.getInt(1);
                std_total.setText("Total Students : " + count);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        ClassesTeachers2 tea = new ClassesTeachers2();
        tea.setVisible(true);
        dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Classes2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
