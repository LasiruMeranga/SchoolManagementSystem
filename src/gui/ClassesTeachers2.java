 ...
 * @author Lasiru
 */
public class ClassesTeachers2 extends javax.swing.JFrame {

    Connection connection = null;

    public ClassesTeachers2() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ClassesTeachers2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ClassesTeachers2().setVisible(true);
            }
        });
    }
