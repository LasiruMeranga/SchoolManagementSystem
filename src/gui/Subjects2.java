 ...
 * @author Lasiru
 */
public class Subjects2 extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Subjects2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
