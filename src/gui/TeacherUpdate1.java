 ...
 * @author Lasiru
 */
public class TeacherUpdate1 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(btn_update, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 480, 100, 40));
        ...
        try {
            ...
            while (rs.next()) {
                if (tId == rs.getInt("Teacher_Id")) {
                    ...
                    teacher_age.setText(String.format("%s", rs.getInt("Age")));
    ...
    private void btn_updateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_updateActionPerformed
        try {
            ...
            if (!teacher_age.equals("") && (teacher_age != null) && (!teacher_contact.equals("")) && (teacher_contact != null)) {
                ...
                String query = "UPDATE teacher SET Name=?,Nic_No=?,Age=?,Gender=?,Address=?,Contact_No=?,Class=?,Subject=?,Qualifications=? WHERE Teacher_Id=?";

                PreparedStatement preparedStmt = connection.prepareStatement(query);
                preparedStmt.setString(1, tName);
                preparedStmt.setString(2, tNic);
                preparedStmt.setInt(3, tAge);
                preparedStmt.setString(4, tGender);
                preparedStmt.setString(5, tAddress);
                preparedStmt.setInt(6, tContact);
                preparedStmt.setString(7, tGrade);
                preparedStmt.setString(8, tSubject);
                preparedStmt.setString(9, tQualifications);
                preparedStmt.setInt(10, tId);

                preparedStmt.executeUpdate();
                JOptionPane.showMessageDialog(rootPane, "Teacher Updated Successfuly");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TeacherUpdate1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TeacherUpdate1().setVisible(true);
            }
        });
    }
