...
public class Menu2 extends javax.swing.JFrame {
    ...
    public void Record() {
        try {
            ...
            while (rs.next()) {
                ...
                String tbData[] = {Id, Name, Dob, Class, Contact};
    ...
    public void Record2() {
        try {
            ...
            while (rs.next()) {
                ...
                String tbData[] = {Id, Name, Subject, Class, Contact,};
    ...
    private void initComponents() {
        ...
        jPanel1.add(tea_total, new org.netbeans.lib.awtextra.AbsoluteConstraints(740, 100, 450, 110));
        ...
        table_all.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Student_Id", "Name", "Date_of_Birth", "Class", "Contact_No"
            }
        ) {
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 220, 440, 430));
        ...
        table_teachers.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Teacher_Id", "Name", "Subject", "Class", "Contact_No"
            }
        ) {
            boolean[] canEdit = new boolean [] {
                false, false, false, false, false
        ...
        jScrollPane2.setViewportView(table_teachers);

        jPanel1.add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(740, 220, 450, 430));
