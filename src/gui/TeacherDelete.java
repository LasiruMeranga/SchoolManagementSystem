...
public class TeacherDelete extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel11.setText("Delete Teacher");
        ...
        jPanel1.add(btn_clear, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 50, 70, -1));
        ...
        jPanel1.add(btn_delete, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 480, 100, 40));
    ...
    private void btn_deleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_deleteActionPerformed
        try {
            ...
            int tId = Integer.parseInt(teacher_id.getText());

            String query = "delete from teacher where Teacher_Id = '" + tId + "' ";
            ...
            teacher_nic.setText("");
            teacher_age.setText("");
            teacher_gender.setSelectedItem("");
            teacher_address.setText("");
            teacher_contact.setText("");
            teacher_class.setSelectedItem("");
            teacher_subject.setText("");
            ...
            JOptionPane.showMessageDialog(rootPane, "Teacher Deleted Successfuly");
